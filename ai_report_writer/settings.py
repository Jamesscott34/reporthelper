...
SECRET_KEY = os.getenv(
    "SECRET_KEY", "django-insecure-(%fi@)nl#+9o-)^mwc@265jp=8sik^7rd=8yicra8%q&9lutq2"
)
...
ASGI_APPLICATION = "ai_report_writer.asgi.application"

# Channel Layers (Redis backend for real-time features)
CHANNEL_LAYERS = {
    "default": {
